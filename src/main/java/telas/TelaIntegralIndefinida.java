...
/**
 * Tela para cálculo de integrais indefinidas
 * Permite ao usuário inserir uma função e calcular sua integral
 *
 * @author Aluno
 */
public class TelaIntegralIndefinida extends JFrame {
    ...
    private void configurarLayout() {
        // Labels
        JLabel lblTitulo = new JLabel("Integral Indefinida");
    ...
    private JTextField obterCampoAtivo() {
        ...
        if (campoValorX.hasFocus()) return campoValorX;
    ...
    /**
     * Calcula a integral com base nos dados inseridos
     */
